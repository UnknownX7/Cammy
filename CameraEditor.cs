    ...
    public class CameraEditor : IDisposable
    {
        ...
        public void Draw()
        {
            if (editorVisible)
            {
                ...
                ResetSliderFloat("Minimum Zoom", ref MinZoom, 1f, MaxZoom, Defaults.MinZoom, 1.5f, "%.2f");
                ...
                ResetSliderFloat("Minimum FoV", ref MinFoV, 0.01f, MaxFoV, Defaults.MinFoV, 0.69f, "%f");
